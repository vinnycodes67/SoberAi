...
// `EllipseFit` lives in `PupilMetricsAnalyzer`. This file carried an
// identical copy that additionally returned a centre point nothing read;
// two implementations of the same measurement is exactly how they drift.
