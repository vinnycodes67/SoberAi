...
# -*- coding: utf-8 -*-
"""
Vendored unmodified from https://github.com/AayushKrChaudhary/RITnet
(MIT License, see RITNET_LICENSE.md in this directory) so
ritnet_openeds2019_pretrained.pkl's state_dict has a matching module
definition to load into. See ../README.md for provenance and citation.
